...
const Header = () => {
  ...
  return (
    <header className={`grid z-30 transition-all delay-150 ease-in-out ${isScrolled ? "fixed laptop:left-0 laptop:right-0 w-screen backdrop-blur-blur ": null} ${showMobileMenu && "h-full"} w-full laptop:grid-cols-12 laptop:max-w-screen-tv mx-auto grid-cols-2 laptop:items-center laptop:px-24 px-6 laptop:py-[22px] tablet:px-14 py-6`}>
      ...
      <div className={`fixed z-30 laptop:relative transition-all delay-150 ease-in-out ${showMobileMenu ? "right-0 left-0 h-full": "right-[-120%]"} w-full  laptop:right-0  laptop:h-max z-20 pt-[35%] tablet:pt-[5.5%] laptop:pt-0 laptop:gap-0 gap-[130px] tablet:gap-8 tablet:px-14 px-6 laptop:px-0 backdrop-blur-blur flex flex-col laptop:backdrop-blur-none laptop:col-span-10 laptop:grid-cols-12 laptop:grid`}>
      ...
      <div className="col-span-1 flex laptop:items-center justify-end laptop:hidden z-30 relative">
