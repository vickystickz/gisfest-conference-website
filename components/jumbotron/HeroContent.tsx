...
const HeroContent = ({ conference, buttons}: THeroContent) => {
  return (
    <div className='z-20 flex-grow flex flex-col laptop:gap-24 gap-14 tablet:gap-12  w-full relative h-full laptop:mt-[3%] tablet:mt-[3%] mt-[15%] px-3 laptop:px-24 tablet:px-14 max-w-screen-tv mx-auto'>
